...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240622170942_update_1.2")]
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.Colors", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("db03ca95-c26d-4453-8e03-5872c479248b"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 384, DateTimeKind.Local).AddTicks(1624),
                            Description = "",
                            Name = "White",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("fec46e82-9948-46c2-b565-61e4aa678760"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 384, DateTimeKind.Local).AddTicks(1642),
                            Description = "",
                            Name = "Black",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("28a7a11d-93bd-45ef-8c77-95af3a2dad3d"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 384, DateTimeKind.Local).AddTicks(1644),
                            Description = "",
                            Name = "Red",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("c0e8815a-2272-4024-807b-b9facb5747ce"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 384, DateTimeKind.Local).AddTicks(1646),
                            Description = "",
                            Name = "Blue",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("fb388775-e07d-4bd8-912d-83d6c036acd1"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 384, DateTimeKind.Local).AddTicks(1648),
                            Description = "",
                            Name = "Green",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.Sizes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("e6f1600b-1c32-42ea-91f9-f4265095e257"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 438, DateTimeKind.Local).AddTicks(7002),
                            Description = "",
                            Name = "XS",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("19e4efec-95d4-45b7-9452-38e515f03648"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 438, DateTimeKind.Local).AddTicks(7025),
                            Description = "",
                            Name = "S",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("7e7eb40a-a0df-4b07-8054-2867483a40fd"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 438, DateTimeKind.Local).AddTicks(7027),
                            Description = "",
                            Name = "M",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("06b19cfa-b3d1-4269-b57d-f4ec9aca1975"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 438, DateTimeKind.Local).AddTicks(7029),
                            Description = "",
                            Name = "L",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("b75d038f-c495-4e85-bc50-b04578d3e509"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 23, 0, 9, 42, 438, DateTimeKind.Local).AddTicks(7032),
                            Description = "",
                            Name = "XL",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "de69c655-a092-4dee-b4b8-d64eee72198e",
                            Name = "Admin",
                            NormalizedName = "Admin"
                        },
                        new
                        {
                            Id = "6bb7bd12-c196-4762-aa2f-565d46744ccf",
                            Name = "Client",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bfa7323f-9d65-4fd3-95aa-1685e22ba653",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "964174cf-c72d-4933-a4d1-a462bbbcf125",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin@gmail.com",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEIHhvfbvqpfernlwRHAq5qqaiUw2So5FpYOCoy0VsX6ZjflDfyCFaOjfn8PMrXGU6Q==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e53bdb75-8c63-4102-9499-cd4e01aa3417",
