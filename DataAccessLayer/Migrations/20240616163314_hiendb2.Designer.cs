...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240616163314_hiendb2")]
    partial class hiendb2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.Colors", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("b1e17a93-7c15-4a04-947b-cb027619dede"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 282, DateTimeKind.Local).AddTicks(3611),
                            Description = "",
                            Name = "White",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("e95cce0d-c307-4a25-ad84-bd0aca62a307"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 282, DateTimeKind.Local).AddTicks(3637),
                            Description = "",
                            Name = "Black",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("6c83abf3-4c12-4aeb-85cb-c3e228309ae1"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 282, DateTimeKind.Local).AddTicks(3639),
                            Description = "",
                            Name = "Red",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("dd1174c8-5b89-4180-825a-ec47ad1b071a"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 282, DateTimeKind.Local).AddTicks(3640),
                            Description = "",
                            Name = "Blue",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("60c5e576-b456-4f60-b82f-7b27d4915e7f"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 282, DateTimeKind.Local).AddTicks(3642),
                            Description = "",
                            Name = "Green",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.Sizes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("d87fb8e2-c55f-4aa3-8a4b-b8641fa3efb5"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 349, DateTimeKind.Local).AddTicks(3163),
                            Description = "",
                            Name = "XS",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("158ce9ba-ad5f-4d21-82d5-314679c21d37"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 349, DateTimeKind.Local).AddTicks(3186),
                            Description = "",
                            Name = "S",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("22698ece-c801-46e2-bc77-b8a4b5ab9661"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 349, DateTimeKind.Local).AddTicks(3188),
                            Description = "",
                            Name = "M",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("f71c2f67-d354-4044-8586-57c435f7fa3d"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 349, DateTimeKind.Local).AddTicks(3192),
                            Description = "",
                            Name = "L",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("bb4c8c7f-7c3f-442e-96c2-0ee133e3d113"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 6, 16, 23, 33, 14, 349, DateTimeKind.Local).AddTicks(3209),
                            Description = "",
                            Name = "XL",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bb47b2ee-2da2-4065-b9f1-dfcc0399a8c3",
                            Name = "Admin",
                            NormalizedName = "Admin"
                        },
                        new
                        {
                            Id = "2dfffd8a-e07e-4fbd-8d93-28758a9e087b",
                            Name = "Client",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "014491a8-619f-441c-89f5-defdf5c2b65c",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "eaabed03-6400-47c6-bd13-cf84276e3631",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin@gmail.com",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEOmIEiboPE3QR7CZjYQhMpA4padXzNFuTw3ftjNpV86hsCPnhNtP4m1ON2BG+T/5tw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "154a0578-ddc9-4b35-89bf-8f7f6cb26494",
